...
class CalendarWeekDay{
  ...
  public function reservedUserCount($ymd){
    ...
    $count = 0;
    if($one_part) $count += $one_part->users_count;
    if($two_part) $count += $two_part->users_count;
    if($three_part) $count += $three_part->users_count;
