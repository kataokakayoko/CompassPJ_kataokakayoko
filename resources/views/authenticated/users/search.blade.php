      ...
      <div class="search_conditions_inner">
        ...
        <div class="selected_engineer">
          ...
          <div>
            ...
            <div class="subject-checkbox-wrapper" style="display:flex; align-items:center; margin-bottom:5px;">
              <span>{{ $subject->subject }}</span>
              <input type="checkbox" name="subjects[]" value="{{ $subject->id }}" style="margin-left:8px;"
