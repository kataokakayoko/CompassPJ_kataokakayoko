...
<div class="board_area w-100 m-auto d-flex">
    <div class="post_view w-75 mt-5 main-content">
        ...
        <div class="post_bottom_area d-flex justify-content-end" style="position: relative;">
          <div class="d-flex post_status" style="position: absolute; bottom: 0; right: 10px;">
            ...
            <div>
              ...
              @else
                <p class="m-0">
                <i class="far fa-heart like_btn" post_id="{{ $post->id }}" style="color: #ccc;"></i>
                  <span class="like_counts{{ $post->id }}">{{ $post->likes_count }}</span>
                </p>
              @endif
            </div>
    ...
    <div class="other_area w-25">
      <div class=" m-4">
        <div class="post-btn" style="width: 100%; text-align: center;">
          <a href="{{ route('post.input') }}" style="display: block; padding: 10px 0; background-color: #03AAD2; color: white; text-decoration: none; text-align: center;">
            投稿
          </a>
        </div>
